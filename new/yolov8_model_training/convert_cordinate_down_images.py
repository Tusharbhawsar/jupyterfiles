...
img_path = "/home/multi-sy-23/volleyball_serve_model_training/ball/"
com_path = sorted(glob.glob(img_path + "*.jpg")+ glob.glob(img_path + "*.jpeg") + glob.glob(img_path + "*.png"))


df = pd.read_csv("/home/multi-sy-23/volleyball_serve_model_training/Volleyball-Ball-Detection-31-01-2025-18-11-58.csv")
