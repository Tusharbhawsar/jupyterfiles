...
import pandas as pd 
import csv
rally="/home/link-lap-24/vollyballdeshdata/rally_data_sorted/rally/"
rally_like="/home/link-lap-24/vollyballdeshdata/rally_data_sorted/rally_like/"

maincsv= pd.read_csv("/home/link-lap-24/vollyballdeshdata/rally.csv")
new_csv  = "rallynew3_rally_like.csv"
# os.mkdir(new_csv)
...
for i in maincsv["Source Url"]:
    ...
    if os.path.exists(os.path.join(rally,imgName)) or os.path.exists(os.path.join(rally_like,imgName)):
